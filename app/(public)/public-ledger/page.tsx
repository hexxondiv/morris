...
const ErrorState: React.FC<{ error: string; onRetry: () => void }> = ({
  ...
  <div className="text-center py-16">
    ...
    <h3 className="text-xl font-semibold text-p-dark mb-3">
      Unable to Load Data
    </h3>
...
// Loading State
const LoadingState: React.FC = () => <LogoLoader />;

// ================================================
// MAIN COMPONENT
// ================================================

const PublicTransparencyLedger: React.FC = () => {
  const [filterType, setFilterType] = useState<LedgerFilterType>("all");
  const { entries, topDonors, loading, error, refetch } = usePublicLedger(10, filterType);
  ...
  return (
    <div className="space-y-6">
      {/* Hero Cards - Balance and Top Donors */}
...
export default PublicTransparencyLedger;
